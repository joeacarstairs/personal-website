...
At the end, I'll also talk a bit about [how I want to respond](#responding) to
the book.
...
How do I want to respond to _God Is Not Great_? Here's some initial thoughts.


### General principles

First of all, I want to listen well. That means listening with an open heart and
an open mind. I think that's a duty on any thinking person. Of course, listening
with an open heart and an open mind can be really difficult: while I've been
reading, I have had on more than one occasion had to put the book down and try
and think about something else for a while. It's OK to be challenged, and it's
OK to need to take a break. It's not OK to put your fingers in your ears.

### Plan of action

I'd be keen to try writing some response articles to some of the themes in
_God Is Not Great_. I think I have two main strategies to choose between:

1. Directly critique the arguments as they're presented
2. Tell an alternative story, and show why it's a better story than the one
   Hitchens was trying to tell in this book

The first strategy has the strength that it tackles arguments head-on, and thus
has a better chance of responding to those arguments robustly. However, it won't
have much positive persuasive power, because it puts me on the defensive and
allows Hitchens to set the agenda.

The second strategy won't be so good at responding to arguments, but will have
more potential persuasive power.

The first strategy will, I think, be generally more effective against the second
main theme of the book: that religion is untrue. This is because, given the
nature of the claim, it's the one which depends on arguments the most heavily.

In contrast, the second strategy will probably be a more suitable response to
the first and third themes of the book, since those lines of thought aren't
really led by arguments.

Since I don't have a huge amount of time to dedicate to this, I should break
topics down small enough that a well-thought-out and well-constructed short
essay is a suitably small project.
