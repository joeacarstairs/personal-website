...
MODULES_blade-canongate := etherpad gemini mox mox-mta-sts mox-autoconfig
...
SUBDOMAIN_ln := ln
SUBDOMAIN_mox := mail
SUBDOMAIN_mox-autoconfig := autoconfig.mail
SUBDOMAIN_mox-clientsettings := clientsettings.mail
SUBDOMAIN_mox-mta-sts := mta-sts.mail
